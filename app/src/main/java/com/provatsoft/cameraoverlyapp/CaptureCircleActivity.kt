...
import kotlinx.android.synthetic.main.activity_capture_photo_inside_circle.*
import java.io.File
import java.io.FileOutputStream
import java.io.IOException
import java.io.OutputStream

class CaptureCircleActivity : AppCompatActivity(), OnRequestPermissionsResultCallback {
            ...
            when (v.id) {
                R.id.takePictureButton -> if (ContextCompat.checkSelfPermission(
                    ...
                    if (cameraView != null) {
                        ...
                        this@CaptureCircleActivity, Manifest.permission.WRITE_EXTERNAL_STORAGE
                    )
                ) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_capture_photo_inside_circle)
        if (cameraView != null) {
